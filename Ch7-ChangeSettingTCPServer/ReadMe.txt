========================================================================
    콘솔 응용 프로그램 : Ch7-ChangeSettingTCPServer 프로젝트 개요
========================================================================

응용 프로그램 마법사에서 이 Ch7-ChangeSettingTCPServer 응용 프로그램을 만들었습니다.

Ch7-ChangeSettingTCPServer 응용 프로그램을 구성하는 각 파일에 대한
요약 설명이 포함되어 있습니다.


Ch7-ChangeSettingTCPServer.vcxproj
...
Ch7-ChangeSettingTCPServer.vcxproj.filters
...
Ch7-ChangeSettingTCPServer.cpp
    기본 응용 프로그램 소스 파일입니다.
...
StdAfx.h, StdAfx.cpp
    이 파일은 미리 컴파일된 헤더(PCH) 파일 Ch7-ChangeSettingTCPServer.pch와 미리 컴파일된 형식(PCT) 파일 StdAfx.obj를 빌드하는 데 사용됩니다.
